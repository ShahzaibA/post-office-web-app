...
class RoutePackage extends Component {
    ...
    renderDialogComponent() {
        return (
            <div>
                ...
                >
                    <DialogTitle id="form-dialog-title">Route Package</DialogTitle>
                    <DialogContent>
                        <TextField
                            autoFocus
                            id="Package_ID"
    ...
    renderPackageList = ({ Package_ID, Shipping_Address, Shipping_City, Shipping_State_Abbr, Shipping_Zip, Hub_ID }) =>
        <TableRow key={Package_ID}>
            ...
            <TableCell align="right"><Button size='sm' variant="outline-danger" onClick={() => this.handleClickOpen(Package_ID, Hub_ID)} >Route Package</Button></TableCell>
        </TableRow>
...
RoutePackage.propTypes = {
    classes: PropTypes.object.isRequired,
};

export default withStyles(styles)(RoutePackage);